...
const ProjectsPage = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Comprehensive marketing materials including posters, social media assets, and print collateral.",
      image: Grap3,
      technologies: ["Illustrator", "Photoshop", "Marketing Design", "Print Design"],
      category: "graphic",
    },
    {
      id: 7,
